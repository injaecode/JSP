...
<% 
	...
	ResultSet rs=null;
	//get방식으로 넘어오는 변수 값을 저장
	//String 형식으로 넘어옴 ->정수로 변환
	...
	*/
	...
	//preparedStatement 객체를 사용해서 처리, 변수에 들어가는 값을 ?로 처리
...
%>
	...
	<table width='600' cellspacing='0' cellpadding='2' align='center'>
			   ...
			   <div align='left'><font size='2'></div> </td>
			   </tr>
   ...
   <table width="600" border="0" cellpadding="0" cellspacing="5">
	<tr> 
		...
		<td width="70" align="right"><A href="freeboard_update"><img src="image/edit.jpg" border=0></A></td>
